...
var (
    getBackground    = `<svg height="{0:d}" width="{0:d}" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg"><path d="m0 0h64v64h-64z" fill="#{1:s}"/></svg>`
    getBeardMustache = `
<svg width="{0:d}" height="{0:d}" viewBox="0 0 64 64" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    <defs>
    ...
    <g id="face" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <g id="Facial-Hair" transform="translate(18.000000, 28.000000)">
            <mask id="mask-2" fill="white">
                <use xlink:href="#path-1" fill-opacity="0.4">
                	<path d="M10.8956938,6.6310802 C12.1391474,6.20678218 13.4857125,6.81653808 14,8.00090947 C14.5142875,6.81653808 15.8608526,6.20678218 17.1043062,6.6310802 L19.5274283,7.45791118 C22.992911,6.12710456 25.9521992,3.64111062 27.9968866,0.701774452 C27.9989588,0.800932919 28,0.900344863 28,1 L28,7 C28,14.7319865 21.7319865,21 14,21 C6.2680135,21 1.77635684e-15,14.7319865 0,7 L0,1 C0,0.900344863 0.0010412311,0.800932919 0.00311340763,0.701774452 C2.04780082,3.64111062 5.007089,6.12710456 8.47257173,7.45791118 L10.8956938,6.6310802 Z" id="path-1"></path>
                </use>
            </mask>
            <use id="Dye" fill="#{1:s}" fill-rule="nonzero" xlink:href="#path-1">
              <path d="M10.8956938,6.6310802 C12.1391474,6.20678218 13.4857125,6.81653808 14,8.00090947 C14.5142875,6.81653808 15.8608526,6.20678218 17.1043062,6.6310802 L19.5274283,7.45791118 C22.992911,6.12710456 25.9521992,3.64111062 27.9968866,0.701774452 C27.9989588,0.800932919 28,0.900344863 28,1 L28,7 C28,14.7319865 21.7319865,21 14,21 C6.2680135,21 1.77635684e-15,14.7319865 0,7 L0,1 C0,0.900344863 0.0010412311,0.800932919 0.00311340763,0.701774452 C2.04780082,3.64111062 5.007089,6.12710456 8.47257173,7.45791118 L10.8956938,6.6310802 Z" id="path-1"></path>
            </use>
...
`
    getSkin = `
<svg height="{0:d}" width="{0:d}" viewBox="0 0 64 64"  xmlns="http://www.w3.org/2000/svg"><g fill="none" transform="translate(14 13)"><path d="m23 33.0807424v5.9192576c0 2.7614237-2.2385763 5-5 5s-5-2.2385763-5-5v-5.9192576c-4.03776277-1.5443264-7.17755008-4.9044416-8.42044769-9.0814314-.02646239.0004587-.05298045.000689-.07955231.000689-2.48528137 0-4.5-2.0147186-4.5-4.5 0-2.3162768 1.75002477-4.2238135 4-4.4725356v-1.0274644c0-7.7319865 6.2680135-14 14-14s14 6.2680135 14 14v1.0274644c2.2499752.2487221 4 2.1562588 4 4.4725356 0 2.4852814-2.0147186 4.5-4.5 4.5-.0265719 0-.0530899-.0002303-.0795523-.000689-1.2428976 4.1769898-4.3826849 7.537105-8.4204477 9.0814314z" fill="#{1:s}"/>
...
`
    getMustache  = `<svg height="{0:d}" width="{0:d}" fill="#{1:s}" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg"> <path d="M32.016 38.05a2.718 2.718 0 0 1-3.182 1.587l-5.082-1.3a1 1 0 0 1-.075-1.916l5.235-1.786a2.504 2.504 0 0 1 3.104 1.37 2.504 2.504 0 0 1 3.105-1.37l5.235 1.786a1 1 0 0 1-.075 1.915l-5.082 1.3a2.717 2.717 0 0 1-3.183-1.587z" /></svg>`
    getGoatee    = `<svg width="{0:d}" height="{0:d}" fill="#{1:s}" viewBox="0 0 64 64"><path d="M28.033 36.527C29.444 36.176 30.766 36 32 36s2.556.176 3.967.527A4 4 0 0 1 39 40.408v4.475a3 3 0 0 1-1.513 2.606C35.72 48.496 33.944 49 32.157 49c-1.807 0-3.666-.514-5.578-1.542A3 3 0 0 1 25 44.816v-4.408a4 4 0 0 1 3.033-3.881zm.019 1.492a2 2 0 0 0-1.462 1.926v2.485a3 3 0 0 0 1.846 2.769c1.282.534 2.504.801 3.668.801 1.15 0 2.338-.26 3.567-.781a3 3 0 0 0 1.829-2.762v-2.5a2 2 0 0 0-1.47-1.93 15.16 15.16 0 0 0-4.03-.565c-1.304 0-2.62.185-3.948.557z"/></svg>`
    getShadow    = `<svg width="{0:d}" height="{0:d}" fill="#{1:s}" viewBox="0 0 64 64"><path d="M46 29v4c0 7.732-6.268 14-14 14s-14-6.268-14-14v-4c0-.1.001-.2.003-.298C20.048 31.642 22.535 35.669 26 37c2-1.003 4-1.504 6-1.504s4 .501 6 1.504c3.465-1.33 5.952-5.359 7.997-8.298.002.099.003.198.003.298z" opacity=".2"/></svg>`
    getSoulpatch = `<svg width="{0:d}" height="{0:d}" fill="#{1:s}" viewBox="0 0 64 64"><path d="M30 43.5h4l-.684 2.051a1.387 1.387 0 0 1-2.632 0z"/></svg>`
    getWalrus    = `<svg width="{0:d}" height="{0:d}" fill="#{1:s}" viewBox="0 0 64 64"><path d="M29 35h6a5 5 0 0 1 5 5H24a5 5 0 0 1 5-5z"/></svg>`

    getEyesGlasses    = `<svg width="{0:d}" height="{0:d}" viewBox="0 0 64 64"><g fill="none"><path fill="#1b0640" d="M26 30a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zm12 0a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3z"/><path fill="#fff" d="M23 26h6v6h-6zm12 0h6v6h-6z" opacity=".303"/><path fill="#1b0640" d="M31 25.053h2c1.5 0 2.5-1.053 5-1.053 1.667 0 3.333.35 5 1.053l1 .526v1.579l-1 .526v3.158C43 32.586 41.657 34 40 34h-4c-1.657 0-3-1.414-3-3.158v-3.684h-2v3.684C31 32.586 29.657 34 28 34h-4c-1.657 0-3-1.414-3-3.158v-3.158l-1-.526v-1.58l1-.525C22.667 24.35 24.333 24 26 24c2.5 0 3.5 1.053 5 1.053zm-2.757 1.47c-.844-.296-1.425-.418-2.243-.418-.995 0-1.993.15-3 .45v4.287c0 .581.448 1.053 1 1.053h4c.552 0 1-.472 1-1.053v-4.051c-.209-.07-.447-.155-.757-.267zm7.514 0c-.31.113-.548.198-.757.268v4.051c0 .581.448 1.053 1 1.053h4c.552 0 1-.472 1-1.053v-4.287c-1.007-.3-2.005-.45-3-.45-.818 0-1.399.122-2.243.419z"/></g></svg>`
    getEyesHappy      = `<svg width="{0:d}" height="{0:d}" viewBox="0 0 64 64"><path fill="#000000" d="M24.712 29.737a.75.75 0 1 1-1.424-.474c.434-1.301 1.383-2.013 2.712-2.013s2.278.712 2.712 2.013a.75.75 0 1 1-1.424.474c-.233-.699-.617-.987-1.288-.987s-1.055.288-1.288.987zm12 0a.75.75 0 0 1-1.424-.474c.434-1.301 1.383-2.013 2.712-2.013s2.278.712 2.712 2.013a.75.75 0 0 1-1.424.474c-.233-.699-.617-.987-1.288-.987s-1.055.288-1.288.987z"/></svg>`
    getEyesOpen       = `<svg width="{0:d}" height="{0:d}" viewBox="0 0 64 64"><path fill="#000000" d="M25.5 30a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zm13 0a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3z"/></svg>`
    getEyesSleepy     = `<svg width="{0:d}" height="{0:d}" viewBox="0 0 64 64"><path fill="#000000" d="M36.004 29.368a1 1 0 1 1 .992-1.736c.438.25.852.368 1.254.368s.816-.118 1.254-.368a1 1 0 1 1 .992 1.736c-.73.417-1.482.632-2.246.632s-1.517-.215-2.246-.632zm-12 0a1 1 0 0 1 .992-1.736c.438.25.852.368 1.254.368s.816-.118 1.254-.368a1 1 0 0 1 .992 1.736c-.73.417-1.482.632-2.246.632s-1.517-.215-2.246-.632z"/></svg>`
    getEyesSunglasses = `<svg width="{0:d}" height="{0:d}" viewBox="0 0 64 64"><g fill="#000000"><path d="M26 30a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zm12 0a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3z"/><path d="M23 26h6v6h-6zm12 0h6v6h-6z" opacity=".801"/><path d="M33 25.053c1.5 0 2.5-1.053 5-1.053 1.667 0 3.333.35 5 1.053l1 .526v1.579l-1 .526v3.158C43 32.586 41.657 34 40 34h-4c-1.657 0-3-1.414-3-3.158v-3.684h-2v3.684C31 32.586 29.657 34 28 34h-4c-1.657 0-3-1.414-3-3.158v-3.158l-1-.526v-1.58l1-.525C22.667 24.35 24.333 24 26 24c2.5 0 3.5 1.053 5 1.053zm-4.757 1.47c-.844-.296-1.425-.418-2.243-.418-.995 0-1.993.15-3 .45v4.287c0 .581.448 1.053 1 1.053h4c.552 0 1-.472 1-1.053v-4.051c-.209-.07-.447-.155-.757-.267zm7.514 0c-.31.113-.548.198-.757.268v4.051c0 .581.448 1.053 1 1.053h4c.552 0 1-.472 1-1.053v-4.287c-1.007-.3-2.005-.45-3-.45-.818 0-1.399.122-2.243.419z"/></g></svg>`
    getEyesWink       = `<svg width="{0:d}" height="{0:d}" viewBox="0 0 64 64"><path fill="#000000" d="M25.5 30a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zm14.907-2.744a.75.75 0 0 1 .186 1.488l-4 .5a.75.75 0 0 1-.186-1.488z"/></svg>`

    getMouthBigsmile = `<svg width="{0:d}" height="{0:d}" viewBox="0 0 64 64"><path fill="#1b0640" d="M29 38h6v1a3 3 0 0 1-6 0z"/></svg>`
    getMouthFrown    = `<svg width="{0:d}" height="{0:d}" viewBox="0 0 64 64"><path fill="#1b0640" d="M28.004 40.132a1 1 0 0 0 .992 1.736C30.016 41.285 31.014 41 32 41s1.983.285 3.004.868a1 1 0 1 0 .992-1.736C34.684 39.382 33.348 39 32 39c-1.348 0-2.684.382-3.996 1.132z"/></svg>`
    getMouthLips     = `<svg width="{0:d}" height="{0:d}" viewBox="0 0 64 64"><g fill="none"><path fill="#dc5c7a" d="M28 41h8c-.667 1.667-2 2.5-4 2.5s-3.333-.833-4-2.5z"/><path fill="#f57b98" d="M32 40a2.092 2.092 0 0 1 3.612.225L36 41h-8l.388-.775A2.092 2.092 0 0 1 32 40z"/></g></svg>`
    getMouthPacifier = `<svg width="{0:d}" height="{0:d}" viewBox="0 0 64 64"><g fill="none"><path fill="#456dff" d="M34.996 42.665a3 3 0 0 1-5.992 0A3.5 3.5 0 0 1 27 39.5a2.035 2.035 0 0 1 2.73-1.912c.756.275 1.513.412 2.27.412s1.514-.137 2.27-.412A2.035 2.035 0 0 1 37 39.5a3.5 3.5 0 0 1-2.004 3.165zM33.415 43h-2.83a1.5 1.5 0 0 0 2.83 0z"/><g fill="#fff" transform="translate(23 36)"><path fill-opacity=".26" d="M11.996 6.665a3 3 0 1 0-5.991 0A3.5 3.5 0 0 1 4 3.5a2.035 2.035 0 0 1 2.73-1.912C7.485 1.863 8.242 2 9 2s1.514-.137 2.27-.412A2.035 2.035 0 0 1 14 3.5a3.5 3.5 0 0 1-2.004 3.165zM10.415 7h-2.83a1.5 1.5 0 1 1 2.83 0z"/><circle cx="9" cy="4.5" r="1.5"/></g></g></svg>`
    getMouthSmile    = `<svg width="{0:d}" height="{0:d}" viewBox="0 0 64 64"><path fill="#1b0640" d="M28.004 41.868a1 1 0 0 1 .992-1.736c1.02.583 2.018.868 3.004.868s1.983-.285 3.004-.868a1 1 0 1 1 .992 1.736C34.684 42.618 33.348 43 32 43c-1.348 0-2.684-.382-3.996-1.132z"/></svg>`
    getMouthSmirk    = `<svg width="{0:d}" height="{0:d}" viewBox="0 0 64 64"><path fill="#1b0640" d="M30.318 41.728a.75.75 0 0 1 .364-1.456c2.433.609 4.165.32 5.288-.802a.75.75 0 0 1 1.06 1.06c-1.544 1.545-3.812 1.923-6.712 1.198z"/></svg>`
    getMouthSurprise = `<svg width="{0:d}" height="{0:d}" viewBox="0 0 64 64"><ellipse cx="32" cy="41" fill="#1b0640" rx="2" ry="2.5"/></svg>`

    getNoseMediumround = `
<svg width="{0:d}" height="{0:d}" viewBox="0 0 64 64"><g fill="none"><path fill="#623D36" d="M28.25 34a.75.75 0 0 1 .75-.75h6a.75.75 0 0 1 .75.75c0 1.664-1.586 3.25-3.75 3.25-2.164 0-3.75-1.586-3.75-3.25z"/>
  <path style="mix-blend-mode: overlay" fill="#fff" d="M35 33.25a.75.75 0 0 0-.75.75c0 .836-.914 1.75-2.25 1.75s-2.25-.914-2.25-1.75a.75.75 0 0 0-.75-.75v-.002h6z" opacity=".36"/></g></svg>`
    ...
    getNoseSmallround = `<svg width="{0:d}" height="{0:d}" viewBox="0 0 64 64"><g fill="none"><path fill="#623D36" d="M29.288 35.237a.75.75 0 0 1 .475-.949 1.09 1.09 0 0 1 .307-.028H33.92c.133 0 .263.01.317.028a.75.75 0 0 1 .475.95c-.434 1.3-1.383 2.012-2.712 2.012s-2.278-.712-2.712-2.013z"/>
<path style="mix-blend-mode: overlay" fill="#fff" d="M33.945 34.255c-.3 0-.558.212-.657.508-.233.699-.617.987-1.288.987s-1.055-.288-1.288-.987c-.1-.296-.367-.503-.657-.503z" opacity=".36"/></g></svg>`
    ...
    getNoseWrinkles = `<svg width="{0:d}" height="{0:d}" viewBox="0 0 64 64"><g fill="none"><path fill="#623D36" d="M29.18 33.758h5.632c.335 0 .593.045.776.276.037.056.083.139.099.182.208.574.284 1.252.229 2.033-.223 1.613-1.589 2.501-3.916 2.501-2.321 0-3.686-.884-3.914-2.488-.054-.814.027-1.509.242-2.084.012-.032.035-.069.066-.12.18-.247.454-.3.785-.3z"/>
<path style="mix-blend-mode: overlay" fill="#fff" d="M34.794 33.779a.75.75 0 0 0-.515.927c.523 1.83-.089 2.544-2.279 2.544s-2.802-.713-2.279-2.544a.75.75 0 0 0-.515-.927c-.069-.02-.037-.019-.105-.019h5.773c-.053 0-.08.006-.08.019z" opacity=".36"/>
</g></svg>`

    getCheckered = `
<svg width="{0:d}" height="{0:d}" viewBox="0 0 64 64">
  <path fill="#{1:s}" d="M27 49v3a5 5 0 0 0 10 0v-3l6.647 2.045A9 9 0 0 1 50 59.647V64H14v-4.353a9 9 0 0 1 6.353-8.602z"/>
...
`
    ...
    getExtralong = `<svg width="{0:d}" height="{0:d}" viewBox="0 0 64 64"><g fill="none"><path fill="#{1:s}" d="M46 28c-1.807-2.008-3.13-4.5-3.97-7.474-1.87 2.283-4.546 3.607-8.03 3.974-5.832.614-10.817-.327-14.953-2.822A13.959 13.959 0 0 0 18 27v1.027a4.474 4.474 0 0 0-2 .73V27.5C16 18.387 23.163 11 32 11s16 7.387 16 16.5v1.258a4.474 4.474 0 0 0-2-.73zm2 8.242V64H37V46.08A14.036 14.036 0 0 0 45.42 37h.08a4.48 4.48 0 0 0 2.5-.758zM27 64l-11.13-.068.13-27.69a4.48 4.48 0 0 0 2.58.757A14.036 14.036 0 0 0 27 46.081v5.464c.034 1.57.034 5.723 0 12.455z"/><path fill="#fff" d="M46 28c-1.807-2.008-3.13-4.5-3.97-7.474-1.87 2.283-4.546 3.607-8.03 3.974-5.832.614-10.817-.327-14.953-2.822A13.959 13.959 0 0 0 18 27v1.027a4.474 4.474 0 0 0-2 .73V27.5C16 18.387 23.163 11 32 11s16 7.387 16 16.5v1.258a4.474 4.474 0 0 0-2-.73z" opacity=".258"/></g></svg>`
    getFade      = `
<svg width="{0:d}" height="{0:d}" viewBox="0 0 64 64"><linearGradient id="a" x1="50%" x2="50%" y1="0%" y2="100%"><stop style="stop-color: {1:s}" offset="0"/><stop style="stop-color: {1:s}" offset="1" stop-opacity="0"/></linearGradient>
  <g fill="none">
    ...
    <path fill="#{1:s}" d="M27.977 13.226L40 12a6.838 6.838 0 0 1-6.487 9h-6.216a3 3 0 0 1-3-3v-.7a4.096 4.096 0 0 1 3.68-4.074z"/>
  </g>
</svg>`
    getHat = `
<svg height="{0:d}" width="{0:d}" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
  <g fill="none">
...
func SaveAll(size int) {
    ...
    for _, style := range skinStyles {
        for _, color := range skinColors {
            svgData = getHtml(style, size, color)
            avatar := image.NewRGBA(image.Rect(0, 0, size, size))
            err = drawAvatar(avatar, svgData, size)
            if err == nil {
                saveImage(fmt.Sprintf("%s/%s_%s.png", path, style, color), avatar)
            }
        }
    }
    // //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    for _, style := range mouthStyles {
        for _, color := range disabledColors {
            svgData = getHtml(style, size, color)
            avatar := image.NewRGBA(image.Rect(0, 0, size, size))
            err = drawAvatar(avatar, svgData, size)
            if err == nil {
    ...
    // //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    path = root + "/FacialHair"
    err = os.MkdirAll(path, 0777)
    if err != nil {
        log.Fatalf("%+v", err)
    }
    for _, style := range facialHairStyles {
        for _, color := range facialHairColors {
            svgData = getHtml(style, size, color)
            avatar := image.NewRGBA(image.Rect(0, 0, size, size))
            err = drawAvatar(avatar, svgData, size)
            if err == nil {
    ...
    for _, style := range noseStyles {
        for _, color := range disabledColors {
            svgData = getHtml(style, size, color)
            println(style, color, svgData)
            avatar := image.NewRGBA(image.Rect(0, 0, size, size))
            err = drawAvatar(avatar, svgData, size)
            if err == nil {
                saveImage(fmt.Sprintf("%s/%s_%s.png", path, style, color), avatar)
...
func saveImage(fileName string, img image.Image) error {
    ...
    err = ioutil.WriteFile(fileName, ret, 0666)
...
func GetRandomAvatar(seed int64) (image.Image, error) {
    ...
    // | "20" "Background" =>
    color = bgColors[rnd.Intn(len(bgColors))]
    style = bgStyles[rnd.Intn(len(bgStyles))]
    svgData = getHtml(style, size, color)
    println(svgData)
    drawAvatar(avatar, svgData, size)

    // | "30" "Skin" =>
    color = skinColors[rnd.Intn(len(skinColors))]
    style = skinStyles[rnd.Intn(len(skinStyles))]
    svgData = getHtml(style, size, color)
    println(svgData)
    drawAvatar(avatar, svgData, size)
    ...
    // | "40" "Head" =>
    // | "70" "Hair" =>
    color = hairColors[rnd.Intn(len(hairColors))]
    style = hairStyles[rnd.Intn(len(hairStyles))]
    svgData = getHtml(style, size, color)
    println(svgData)
    drawAvatar(avatar, svgData, size)

    // | "75" "Body" =>
    color = bodyColors[rnd.Intn(len(bodyColors))]
    style = bodyStyles[rnd.Intn(len(bodyStyles))]
    svgData = getHtml(style, size, color)
    println(svgData)
    drawAvatar(avatar, svgData, size)

    // | "80" "Mouth" =>
    color = disabledColors[rnd.Intn(len(disabledColors))]
    style = mouthStyles[rnd.Intn(len(mouthStyles))]
    svgData = getHtml(style, size, color)
    println(svgData)
    drawAvatar(avatar, svgData, size)

    // | "90" "FacialHair" =>
    color = facialHairColors[rnd.Intn(len(facialHairColors))]
    style = facialHairStyles[rnd.Intn(len(facialHairStyles))]
    svgData = getHtml(style, size, color)
    println(svgData)
    drawAvatar(avatar, svgData, size)
    ...
    // | "100" "Nose" =>
    color = disabledColors[rnd.Intn(len(disabledColors))]
    style = noseStyles[rnd.Intn(len(noseStyles))]
    svgData = getHtml(style, size, color)
    println(svgData)
    drawAvatar(avatar, svgData, size)
    ...
    // | "110" "Eyes" =>
    color = disabledColors[rnd.Intn(len(disabledColors))]
    style = eyeStyles[rnd.Intn(len(eyeStyles))]
    svgData = getHtml(style, size, color)
    println(svgData)
    drawAvatar(avatar, svgData, size)
...
func drawAvatar(avatar *image.RGBA, svgData string, size int) error {
    if svgData == "" {
        return nil
    }
...
func getHtml(name string, size int, fill string) string {
    switch name {
    case "Skin":
        return text.Sprintf(getSkin, size, fill)
    case "Mustache":
        return text.Sprintf(getMustache, size, fill)
    case "BeardMustache":
        return text.Sprintf(getBeardMustache, size, fill)
    case "Goatee":
        return text.Sprintf(getGoatee, size, fill)
    case "Shadow":
        return text.Sprintf(getShadow, size, fill)
    case "Soulpatch":
        return text.Sprintf(getSoulpatch, size, fill)
    case "Walrus":
        return text.Sprintf(getWalrus, size, fill)
    case "Glasses":
        return text.Sprintf(getEyesGlasses, size, fill)
    case "Happy":
        return text.Sprintf(getEyesHappy, size, fill)
    case "Open":
        return text.Sprintf(getEyesOpen, size, fill)
    case "Sleepy":
        return text.Sprintf(getEyesSleepy, size, fill)
    case "Sunglasses":
        return text.Sprintf(getEyesSunglasses, size, fill)
    case "Wink":
        return text.Sprintf(getEyesWink, size, fill)
    case "Bigsmile":
        return text.Sprintf(getMouthBigsmile, size, fill)
    case "Frown":
        return text.Sprintf(getMouthFrown, size, fill)
    case "Lips":
        return text.Sprintf(getMouthLips, size, fill)
    case "Pacifier":
        return text.Sprintf(getMouthPacifier, size, fill)
    case "Smile":
        return text.Sprintf(getMouthSmile, size, fill)
    case "Smirk":
        return text.Sprintf(getMouthSmirk, size, fill)
    case "Surprise":
        return text.Sprintf(getMouthSurprise, size, fill)
    case "Mediumround":
        return text.Sprintf(getNoseMediumround, size, fill)
    case "Smallround":
        return text.Sprintf(getNoseSmallround, size, fill)
    case "Wrinkles":
        return text.Sprintf(getNoseWrinkles, size, fill)
    case "Oval":
        return text.Sprintf(getBodyOval, size, fill)
    case "Checkered":
        return text.Sprintf(getCheckered, size, fill)
    case "Round":
        return text.Sprintf(getBodyRound, size, fill)
    case "Square":
        return text.Sprintf(getBodySquare, size, fill)
    case "Bald":
        return text.Sprintf(getBald, size, fill)
    case "Balding":
        return text.Sprintf(getBalding, size, fill)
    case "Bigcurls":
        return text.Sprintf(getBigcurls, size, fill)
    case "Bobbangs":
        return text.Sprintf(getBobbangs, size, fill)
    case "Bobcut":
        return text.Sprintf(getBobcut, size, fill)
    case "Buncurls":
        return text.Sprintf(getBuncurls, size, fill)
    case "Buzzcut":
        return text.Sprintf(getBuzzcut, size, fill)
    case "Curlybun":
        return text.Sprintf(getCurlybun, size, fill)
    case "Hightopcurly":
        return text.Sprintf(getCurlyhightop, size, fill)
    case "Long":
        return text.Sprintf(getLong, size, fill)
    case "Pigtails":
        return text.Sprintf(getPigtails, size, fill)
    case "Shortcombover":
        return text.Sprintf(getShortcombover, size, fill)
    case "Hat":
        return text.Sprintf(getHat, size, fill)
    case "Beanie":
        return text.Sprintf(getBeanie, size, fill)
    case "Bunundercut":
        return text.Sprintf(getBunundercut, size, fill)
    case "Extralong":
        return text.Sprintf(getExtralong, size, fill)
    case "Fade":
        return text.Sprintf(getFade, size, fill)
    case "Mohawk":
        return text.Sprintf(getMohawk, size, fill)
    case "Shortcomboverchops":
        return text.Sprintf(getShortcomboverchops, size, fill)
    case "Sidebuzz":
        return text.Sprintf(getSidebuzz, size, fill)
    case "Straightbun":
        return text.Sprintf(getStraightbun, size, fill)
    case "Background":
        return text.Sprintf(getBackground, size, fill)
    default:
        return ""
    }
