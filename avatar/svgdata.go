...
//            </mask>
//            <use id="Dye" fill="#{1:s}" fill-rule="nonzero" xlink:href="#path-1"></use>
...
//`
//	getMustache  = `<svg fill="#{1:s}" height="{0:d}" width="{0:d}" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg"> <path d="M32.016 38.05a2.718 2.718 0 0 1-3.182 1.587l-5.082-1.3a1 1 0 0 1-.075-1.916l5.235-1.786a2.504 2.504 0 0 1 3.104 1.37 2.504 2.504 0 0 1 3.105-1.37l5.235 1.786a1 1 0 0 1-.075 1.915l-5.082 1.3a2.717 2.717 0 0 1-3.183-1.587z" /></svg>`
...
//
//	getNoseMediumround = `
//<svg width="{0:d}" height="{0:d}" viewBox="0 0 64 64"><g fill="none"><path fill="#{1:s}" d="M28.25 34a.75.75 0 0 1 .75-.75h6a.75.75 0 0 1 .75.75c0 1.664-1.586 3.25-3.75 3.25-2.164 0-3.75-1.586-3.75-3.25z"/>
...
//
//	getNoseSmallround = `<svg width="{0:d}" height="{0:d}" viewBox="0 0 64 64"><g fill="none"><path fill="#{1:s}" d="M29.288 35.237a.75.75 0 0 1 .475-.949 1.09 1.09 0 0 1 .307-.028H33.92c.133 0 .263.01.317.028a.75.75 0 0 1 .475.95c-.434 1.3-1.383 2.012-2.712 2.012s-2.278-.712-2.712-2.013z"/>
...
//
//	getNoseWrinkles = `<svg width="{0:d}" height="{0:d}" viewBox="0 0 64 64"><g fill="none"><path fill="#{1:s}" d="M29.18 33.758h5.632c.335 0 .593.045.776.276.037.056.083.139.099.182.208.574.284 1.252.229 2.033-.223 1.613-1.589 2.501-3.916 2.501-2.321 0-3.686-.884-3.914-2.488-.054-.814.027-1.509.242-2.084.012-.032.035-.069.066-.12.18-.247.454-.3.785-.3z"/>
